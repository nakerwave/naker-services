 ...
 */
var ResponsiveCatcher = /** @class */ (function () {
    /**
     ...
     * @ignore
     */
    ResponsiveCatcher.prototype._checkViewport = function () {
        ...
        if (!viewport) {
            var viewporttoadd = el('meta', { content: "width=device-width, initial-scale=1", name: "viewport" });
    ...
    ResponsiveCatcher.prototype.checkScaling = function () {
        ...
        if (this.renderWidth / newScale > 800 || this.renderHeight / newScale > 800)
            newScale = 1;
     ...
     */
    ResponsiveCatcher.prototype.sendToListsteners = function () {
     ...
     */
    ResponsiveCatcher.prototype.addListener = function (callback) {
        this._listeners.push(callback);
    };
    /**
     * Remove a listener to stop following responsive change events
     */
    ResponsiveCatcher.prototype.removeListener = function (callback) {
